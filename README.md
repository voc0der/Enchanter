...
- Add a search box back to the legacy enchanting craft pane, with filtering that stays compatible with scans, workbench casting, and the live Enchant button
