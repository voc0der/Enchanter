...
- Add a search box back to the legacy enchanting craft pane, with filtering that stays compatible with scans, workbench casting, the live Enchant button, and the active enchant targeting cursor
