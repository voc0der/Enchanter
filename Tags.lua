...
EC.DefaultEnchanterTags = {
	...
	"looking for ench",
	"looking for enchant",
	"any enchanters online",
	"any enchanter online",
	"any enchants online",
	"need enchanter",
	"need ench",
	"need enchant",
	"need an enchanter",
	"do you have enchanter",
	"do u have enchanter",
	"anyone able to enchant",
	"any1 able to enchant",
}
...
EC.DefaultRecipeTags={
	...
	["Enchant Boots - Dexterity"] = "Enchant Boots - Dexterity,dex to boots,dex to boot,dex to feet,dex boots,dex boot,dex feet,12 dex to boots,12 dex to boot,12 dex boots,12 dex boot,12 dex to feet,12 dex feet,12 agi to boots,12 agi to feet,12 agi boot,dexterity to boot,dexterity to boots,boots agil",
	["Enchant Boots - Fortitude"] = "Enchant Boots - Fortitude,fortitude to boots,fortitude to feet,fort to boots,fort boot,fort to feet,12 stam to boot,12 stam to boots,12 stam boot,12 stam boots,12 stamina to boot,12 stamina to boots,12 stamina boots,boots stamina",
	...
	["Enchant Gloves - Major Spellpower"] = "Enchant Gloves - Major Spellpower,major spellpower,major spell power,sp to hand,sp to hands,sp to glove,sp to gloves,spellpower to glove,spellpower to gloves,spell power to glove,spell power to gloves,20sp to glove,20sp to gloves,20 sp to glove,20 sp to gloves,20+ sp to glove,20+ sp to gloves,20sp glove,20sp gloves,20 sp glove,20 sp gloves,20 spellpower to glove,20 spellpower to gloves,20 spell power to glove,20 spell power to gloves",
	...
	["Enchant Weapon - Major Spellpower"] = "Enchant Weapon - Major Spellpower,spellpower to weap,spellpower to weapon,spell power to weap,spell power to weapon,40 sp,40sp,40 spell,40 spellpower,40 spell power,40+ spell,40 sp to weap,40 sp to weapon,40sp to weap,40sp to weapon,40 spellpower to weap,40 spellpower to weapon,40 spell power to weap,40 spell power to weapon,40 spellpower weapon,40 spell power weapon,sp to weap,sp to weapon,weapon major spell",
