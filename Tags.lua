...
EC.DefaultRecipeTags={
	...
	["Enchant Cloak - Greater Resistance"] = EC.BuildSpecificRecipeTagList("Enchant Cloak - Greater Resistance", {"greater resistance", "5 resist", "5 all resist", "5 all resistance"}),
